...
class Project:
    def __init__(self, name, root_dir, remote_dir=None, out_dir=None, remote_outdir=None,
                 docker: DockerContainerConfig=None, slurm: SlurmConfig=None, singularity: SingularityConfig=None) -> None:
        self.name = name
